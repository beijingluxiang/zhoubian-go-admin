<template>
  <div style="margin-top: 50px">
    <el-form prop="productAttribute" :model="value" ref="productAttrForm" label-width="120px" style="width: 720px" size="small">
      <el-form-item label="属性类型：">
        <el-select v-model="value.productAttributeCategoryId"
                   placeholder="请选择属性类型"
                   @change="handleProductAttrChange" prop="productAttribute">
          <el-option
      ...
      <el-form-item label="商品规格：">
        ...
        <el-table style="width: 100%;margin-top: 20px"
          ...
          <el-table-column
            ...
            align="center">
            <template slot-scope="scope">
              <el-input v-model="scope.row.chengbenProce"></el-input>
            </template>
          </el-table-column>
          <el-table-column
            label="利润配比价"
            ...
            align="center">
            <template slot-scope="scope">
              <el-input v-model="scope.row.fenxiaoPrice"></el-input>
            </template>
          </el-table-column>
          <el-table-column
            label="商品库存"
      ...
      <!--        </el-card>-->
      <!--      </el-form-item>-->
      <el-form-item label="商品头图列表：">
        <multi-upload v-model="selectProductPics"></multi-upload>
      </el-form-item>

      <el-form-item label="详情页图片列表">
        <multi-upload v-model="selectDetailPics" ></multi-upload>
        <!--        <el-tabs v-model="activeHtmlName" type="card">-->
        <!--          &lt;!&ndash;          <el-tab-pane label="电脑端详情" name="pc">&ndash;&gt;-->
        <!--          &lt;!&ndash;            <tinymce :width="595" :height="300" v-model="value.detailHtml"></tinymce>&ndash;&gt;-->
	...
	export default {
		...
		data() {
			return {
				...
				rules: {
					productAttribute: [{required: true, message: '该项为必填项', trigger: 'blur'}]
				}
			}
		},
		computed: {
			...
			selectDetailPics: {
				get: function () {
					...
					let strings = this.value.detailMobileHtml.split(',');
					if (strings.length > 0) {
